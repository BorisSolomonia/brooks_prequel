  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mt-6 space-y-5 text-sm leading-6 text-ig-text-secondary">
        <section>
          <h2 className="font-display text-lg font-black text-ig-text-primary">Refund window</h2>
        ...
        <section>
          <h2 className="font-display text-lg font-black text-ig-text-primary">Non-refundable cases</h2>
        ...
        <section>
          <h2 className="font-display text-lg font-black text-ig-text-primary">Processing time</h2>
