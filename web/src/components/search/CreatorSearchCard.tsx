    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          {creator.verified && (
            <svg className="w-4 h-4 text-ig-action-blue flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
            </svg>
          )}
        </div>
        <p className="text-sm text-ig-text-secondary truncate">@{creator.username}</p>
        <div className="flex gap-3 mt-0.5 text-xs text-ig-text-tertiary">
