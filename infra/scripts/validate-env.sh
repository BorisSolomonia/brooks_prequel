...
for key in DOMAIN LETSENCRYPT_EMAIL DB_NAME DB_USERNAME AUTH0_DOMAIN AUTH0_AUDIENCE AUTH0_CLIENT_ID AUTH0_CLIENT_SECRET NEXT_PUBLIC_AUTH0_DOMAIN NEXT_PUBLIC_AUTH0_CLIENT_ID NEXT_PUBLIC_AUTH0_AUDIENCE AI_KEY_ENCRYPTION_SECRET UNIPAY_MERCHANT_ID UNIPAY_SECRET_KEY; do
