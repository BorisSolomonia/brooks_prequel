...
require_url UNIPAY_API_BASE_URL

for key in DOMAIN LETSENCRYPT_EMAIL DB_NAME DB_USERNAME DB_PASSWORD AUTH0_DOMAIN AUTH0_AUDIENCE AUTH0_SECRET AUTH0_CLIENT_ID AUTH0_CLIENT_SECRET NEXT_PUBLIC_AUTH0_DOMAIN NEXT_PUBLIC_AUTH0_CLIENT_ID NEXT_PUBLIC_AUTH0_AUDIENCE NEXT_PUBLIC_API_BASE_URL AI_KEY_ENCRYPTION_SECRET ADMIN_EMAILS UNIPAY_MERCHANT_ID UNIPAY_SECRET_KEY; do
